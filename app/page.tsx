        ...
        <div className="container mx-auto px-3 sm:px-4 lg:px-8">
          <div className="flex h-20 sm:h-24 items-center justify-between">
            <div className="flex items-center space-x-3 sm:space-x-4 min-w-0 flex-1">
              <Image
                src="/images/new-lifecare-logo.png"
                ...
                priority
              />
              <h1 className="text-lg sm:text-xl lg:text-2xl font-bold hidden md:block truncate">
                <span className="text-emerald-600">Swasth</span>
                <span className="text-teal-600">Suraksha</span> <span className="text-indigo-600">Life</span>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2 lg:space-x-4 flex-shrink-0">
              <Link
                href="#contact"
                className="text-xs sm:text-sm font-medium text-gray-700 hover:text-emerald-600 hidden lg:inline whitespace-nowrap"
              >
                Contact Us
              </Link>
      ...
      <section className="py-8 sm:py-12 lg:py-24 bg-gradient-to-b from-emerald-50 via-blue-50 to-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6 lg:space-y-8">
            ...
            <p className="text-base sm:text-lg lg:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-4 animate-hero animate-hero-delay-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-sm sm:max-w-md mx-auto pt-2 sm:pt-4 px-4 animate-hero animate-hero-delay-2">
              <Input
                type="tel"
            ...
            <p className="text-xs sm:text-sm text-gray-500 px-4 animate-hero animate-hero-delay-3">
              ✓ Instant quotes ✓ No paperwork ✓ 24/7 support
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-5xl mx-auto">
            ...
            <ScrollAnimation animation="fade-up" delay={200}>
              <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-all p-3 sm:p-4 lg:p-6">
                ...
                <CardContent className="pt-0">
                  <p className="text-sm sm:text-base text-gray-600">
                    Your parents raised you. Now it's time to protect them. Cover your whole family under one simple
                    plan.
                  </p>
                </CardContent>
              </Card>
            ...
            <ScrollAnimation animation="scale-in" delay={300}>
              <div className="bg-gradient-to-r from-emerald-600 via-teal-600 to-blue-600 rounded-2xl p-4 sm:p-6 lg:p-8 text-white">
                <p className="text-base sm:text-lg lg:text-xl font-medium">
                  Every decision we make, every process we design, every person we hire - it all comes back to this
                  simple truth: <br />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 items-center">
              <div className="space-y-2 sm:space-y-3 lg:space-y-4 text-center lg:text-left">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white">
                  <span className="text-emerald-400">Swasth</span>
                  <span className="text-teal-400">Suraksha</span> <span className="text-blue-400">Life</span>
